...
class BooksApiTestCase(APITestCase):
    ...
    def test_get_ordering(self):
        ...
        books = Book.objects.all().annotate(
            annotated_likes=Count(Case(When(userbookrelation__like=True, then=1))),
            rating=Avg('userbookrelation__rate')).order_by('author_name')
    ...
    def test_create(self):
        ...
        url = reverse('book-list')
        data = {"name": "Python 3", "price": 150, "author_name": "Mark Summerfield"}
    ...
    def test_update(self):
        ...
        data = {"name": self.book_1.name, "price": 575, "author_name": self.book_1.author_name}
        json_data = json.dumps(data)
        self.client.force_login(self.user)
    ...
    def test_update_not_owner(self):
        ...
        expected_data = {'detail': ErrorDetail(string='You do not have permission to perform this action.',
    ...
    def test_delete(self):
        ...
        data = BooksSerializer(self.book_1).data
    ...
    def test_get_1(self):
        url = reverse('book-detail', args=(self.book_1.id,))
        response = self.client.get(url)
        book1 = Book.objects.filter(id__in=[self.book_1.id]).annotate(
            annotated_likes=Count(Case(When(userbookrelation__like=True, then=1))),
            rating=Avg('userbookrelation__rate'))
        serializer_data = BooksSerializer(book1, many=True).data
        self.assertEqual(status.HTTP_200_OK, response.status_code)
